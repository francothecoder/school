...
<form method="post" action="<?= e(base_url('/students/store')) ?>" class="row g-3">
    <div class="col-md-4"><label class="form-label">Student Code</label><input name="student_code" class="form-control" required></div>
    ...
    <div class="col-md-4"><label class="form-label">Password</label><input name="password" type="password" class="form-control"><div class="form-helper mt-2">Leave blank to use student code.</div></div>
    <div class="col-md-4"><label class="form-label">Sex</label><select name="sex" class="form-select"><option value="">Select</option><option value="male">Male</option><option value="female">Female</option></select></div>
