<div class="panel-card">
    ...
    <form method="post" action="<?= e(base_url('/students/bulk-store')) ?>" class="row g-3">
        ...
        <div class="col-md-12">
            <label class="form-label">Students CSV lines</label>
            <textarea name="students_blob" class="form-control" rows="12" placeholder="ST001, Mary Banda, female, mary@example.com, 097...&#10;ST002, John Phiri, male, , 096..." required></textarea>
            <div class="form-helper mt-2">Format per line: student_code, full_name, sex, email, phone</div>
        </div>
